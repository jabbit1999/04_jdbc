package com.wjdqudwls.section03.sqlinjection;

import java.sql.*;

import static com.wjdqudwls.common.JDBCTemplate.close;
import static com.wjdqudwls.common.JDBCTemplate.getConnection;
...
public class Application2 {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      String sql
          = "select * from tbl_menu where menu_code = ? and menu_code = ?"; // DQL : Data Query Language
      ...
      rset = pstmt.executeQuery(); // 싱텍스 오류로 인해 괄호 안에 있던 SQL 지워야함

      while(rset.next()){ // 다음행이 있다면 이동하고 true 반환(반복)
